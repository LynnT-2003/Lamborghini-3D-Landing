    ...
    >
      <defs>
        ...
        >
          {hovered && (
            <>
              <stop offset="0%" stopColor={"var(--yellow-50)"} />
              <stop offset="25%" stopColor={"var(--red-50)"} />
              <stop offset="50%" stopColor={"var(--blue-50)"} />
              <stop offset="75%" stopColor={"var(--cyan-50)"} />
              <stop offset="100%" stopColor={"var(--violet-50)"} />
            </>
          )}
        </linearGradient>
